    ...
    >
      ...
      >
        <p>
          ...
          collect from or about you when you access micropay and its affiliates’
          websites (collectively, the “Site”), or use micropay and its
          affiliates’ products and services, including application programming
          interfaces, associated software, tools, developer services, data and
        ...
        <p>
          <em>Communication Information</em>: If you communicate with us, we may
        ...
        <p>
          ...
          certain information about your visit, use, or interactions (“Technical
        ...
        <p>
          Usage data: We may automatically collect information about your use of
          the Services, such as the types of content that you view or engage
          with, the features you use and the actions you take, as well as your
          time zone, country, the dates and times of access, user agent and
        ...
        <p>
          <em>Cookies</em>: We use cookies to operate and administer our Site
          and Services, and improve your experience on it. A “cookie” is a piece
          of information sent to your browser by a website you visit. You can
          set your browser to accept all cookies, to reject all cookies, or to
        ...
        <p>
          <em>Analytics</em>: We may use a variety of online analytics products
          that use cookies to help us analyze how users use the Site and
          Services and enhance your experience when you use the Site
          and&nbsp;Services.
        </p>
        <p>
          <em>Online Tracking and Do Not Track Signals</em>: We and our third
          party service providers may use cookies or other tracking technologies
        ...
        <ul>
          <li>
            To provide, administer, maintain, improve and/or analyze
            the&nbsp;Services;
          </li>
          <li>
        ...
        <p>
          <em>Aggregated Information</em>. We may aggregate Personal Information
          ...
          parties, published or made generally available) and for other similar
        ...
        <p>
          ...
          law, including without limitation in the situations&nbsp;below:
        </p>
        <ul>
          <li>
            ...
            information technology services providers, event management
            services, email communication software and email newsletter
            services, advertising and marketing services, and web analytics
            services. Pursuant to our instructions, these parties will access,
            process, or store Personal Information in the course of performing
            their duties to&nbsp;us.
          </li>
          <li>
          ...
          <li>
            ...
            common control with micropay. Our affiliates may use the Personal
            Information we share in a manner consistent with this
            Privacy&nbsp;Policy.
          </li>
          <li>
            Other Users: certain actions you take may be visible to other users
            of the&nbsp;Service.
          </li>
        </ul>
        <p>
          <strong>4. HOW TO CONTACT US; UPDATING YOUR&nbsp;INFORMATION</strong>
        </p>
        <p>
          Please contact us at{" "}
          <a
            href="mailto:founders@micropay.ai"
            target="_blank"
            rel="noopener noreferrer"
          >
            founders@micropay.ai
          </a>{" "}
          if you need to change or correct your Personal Information, or if you
          have any questions or concerns not already addressed in this
          Privacy&nbsp;Policy.
        </p>
        <p>
        ...
        <p>
          ...
          limit our ability to use or disclose information as
          described&nbsp;above.
        </p>
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                We use Communication Information for providing our Services and
                responding to you.
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                ...
                for moderation and prevention of fraud and malicious activity by
        ...
        <p>
          Authorized Agents: you may submit a request to know or a request to
          ...
          identity and submit proof of your residency with&nbsp;us.
        </p>
        <p>
        ...
        <p>
          ...
          micropay does not knowingly collect Personal Information from children
          under the age of 13. If you have reason to believe that a child under
          the age of 13 has provided Personal Information to micropay through
          ...
          and we will endeavor to delete that information from
          our&nbsp;databases.
        </p>
        <p>
        ...
        <p>
          ...
          controlled by micropay, including social media services (“Third Party
        ...
        <p>
          ...
          information you send to us via the Service or e-mail. In addition, we
          are not responsible for circumvention of any privacy settings or
          security measures contained on the Service, or third
          party&nbsp;websites.
        </p>
        <p>
        ...
        <p>
          <strong>10. YOUR&nbsp;CHOICES</strong>
        </p>
        <p>
          If you choose not to provide Personal Information that is needed to
          use some features of our Service, you may be unable to use
          those&nbsp;features.
        </p>
        <p>
