  ...
  return (
    <div>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            If you did not recieve your images after 30 seconds, it is likely
            that the request failed. Please share your invoice request to this{" "}
            <a
            ...
            along with your contact information and we can take a look and
            process a refund.
          </Typography>

          <Typography>
            If your request contained any profane language or reference to
            sexual content we will not be offering any refunds as it violates
            the Dalle-2 terms of use.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </div>
